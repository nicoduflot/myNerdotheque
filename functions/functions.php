...
function listMedia(){
    ...
    $tabResult = "";
    $tabResult = $tabResult . "<table class=\"table\">";
    $tabResult = $tabResult . "<thead class=\"thead-dark\"><tr>";
    $tabResult = $tabResult . "<th>Titre</th>";
    $tabResult = $tabResult . "</tr></thead>";
    $tabResult = $tabResult . "<tbody>";
    if($nbRows > 0){
        $i = 0;
        while($i < $nbRows){
            $row = mysqli_fetch_assoc($result);
            $tabResult = $tabResult . "<tr>";
            $tabResult = $tabResult . "<td><a href=\"media.php?idMedia=" . $row["idMedia"] . "\">" . utf8_encode($row["titreMedia"]) . "</a></td>";
            $tabResult = $tabResult . "</tr>";
            $i++;
        }
    }
...
function listAuteur(){
    ...
    $tabResult = $tabResult . "<table class=\"table\">";
    $tabResult = $tabResult . "<thead class=\"thead-dark\"><tr>";
    $tabResult = $tabResult . "<th>Auteur</th><th>Livre(s) lié(s)</th>";
    $tabResult = $tabResult . "</tr></thead>";
    $tabResult = $tabResult . "<tbody>";
    if($nbRows > 0){
        $i = 0;
        while($i < $nbRows){
            $row = mysqli_fetch_assoc($result);
            $tabResult = $tabResult . "<tr>";
            $tabResult = $tabResult . "<td><a href=\"auteur.php?idAuteur=" . $row["idAuteur"] . "\">" . 
...
function listMediaBack(){
    ...
    $tabResult = $tabResult . "<table class=\"table\">";
    $tabResult = $tabResult . "<thead class=\"thead-dark\"><tr>";
    $tabResult = $tabResult . "<th>Titre</th><th colspan=\"2\">Actions</th>";
    $tabResult = $tabResult . "</tr></thead>";
    $tabResult = $tabResult . "<tbody>";
    if($nbRows > 0){
        $i = 0;
        while($i < $nbRows){
            ...
            $tabResult = $tabResult . "<button class='btn btn-sm btn-outline-primary editMediaButton' data-id='" . $row["idMedia"] . "' data-toggle=\"modal\" data-target=\"#editMedia\">";
            $tabResult = $tabResult . "Editer</button> ";
            //$tabResult = $tabResult . "<a href=\"./modMedia.php?idMedia=" . $row["idMedia"] . "\">Editer</a>";
            $tabResult = $tabResult . "</td>";
            $tabResult = $tabResult . "<td>";
            $tabResult = $tabResult . "<a href=\"supEntite.php?entite=media&id=". $row["idMedia"] ."\">Supprimer</a>";
            $tabResult = $tabResult . "</td>";
            $tabResult = $tabResult . "</tr>";
            $i++;
        }
...
function listAuteurBack(){
    ...
    $tabResult = $tabResult . "<table class=\"table\">";
    $tabResult = $tabResult . "<thead class=\"thead-dark\"><tr>";
    $tabResult = $tabResult . "<th>Auteur</th><th>Livre(s) lié(s)</th><th colspan=\"2\">Actions</th>";
    $tabResult = $tabResult . "</tr></thead>";
    $tabResult = $tabResult . "<tbody>";
    if($nbRows > 0){
        $i = 0;
